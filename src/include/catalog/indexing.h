...
DECLARE_UNIQUE_INDEX(gs_sql_limit_rule_enable_type_hash_id_index, 9062, on gs_sql_limit_rule using btree(enable bool_ops, limit_type text_ops, hash int8_ops, limit_id int8_ops));
#define GsSqlLimitRuleEnableTypeHashIdIndex 9062
